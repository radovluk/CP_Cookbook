...
export function readFileAsNumberArray(filename) {
 ...
 */
export function makeModelName(benchmarkName, filename) {
 ...
 */
export function getBoolOption(option, restArgs) {
 ...
 */
export function getStringOption(option, defaultValue, restArgs) {
    let index = restArgs.indexOf(option);
    if (index == -1)
        return defaultValue;
 ...
 */
export function getIntOption(option, defaultValue, restArgs) {
    let index = restArgs.indexOf(option);
    if (index == -1)
        return defaultValue;
    if (index + 1 == restArgs.length) {
 ...
 * The option takes a value. I.e., we expect "--foo nn".
 */
export function getFloatOption(option, defaultValue, restArgs) {
    let index = restArgs.indexOf(option);
    if (index == -1)
        return defaultValue;
    if (index + 1 == restArgs.length) {
